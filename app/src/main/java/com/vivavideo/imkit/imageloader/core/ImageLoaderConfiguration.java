 ...
 *******************************************************************************/
package com.vivavideo.imkit.imageloader.core;
...
import com.vivavideo.imkit.imageloader.cache.disc.DiskCache;
import com.vivavideo.imkit.imageloader.cache.disc.naming.FileNameGenerator;
import com.vivavideo.imkit.imageloader.cache.memory.MemoryCache;
import com.vivavideo.imkit.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.vivavideo.imkit.imageloader.core.assist.FlushedInputStream;
import com.vivavideo.imkit.imageloader.core.assist.ImageSize;
import com.vivavideo.imkit.imageloader.core.assist.QueueProcessingType;
import com.vivavideo.imkit.imageloader.core.decode.ImageDecoder;
import com.vivavideo.imkit.imageloader.core.download.ImageDownloader;
import com.vivavideo.imkit.imageloader.core.process.BitmapProcessor;
import com.vivavideo.imkit.imageloader.utils.L;
import com.vivavideo.imkit.imageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.vivavideo.imkit.imageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.vivavideo.imkit.imageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.vivavideo.imkit.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.vivavideo.imkit.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.vivavideo.imkit.imageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.vivavideo.imkit.imageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.vivavideo.imkit.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.vivavideo.imkit.imageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.vivavideo.imkit.imageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.vivavideo.imkit.imageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.vivavideo.imkit.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.vivavideo.imkit.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.vivavideo.imkit.imageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.vivavideo.imkit.imageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
