...
public class RongNotificationManager {
    ...
    public void onRemoveNotification() {
        messageMap.clear();
        RongPushClient.clearNotificationById(mContext, 1000);
    }
    ...
    public void onEventMainThread(UserInfo userInfo) {
        ...
        Conversation.ConversationType[] types = new Conversation.ConversationType[]{Conversation.ConversationType.PRIVATE, Conversation.ConversationType.GROUP,
                Conversation.ConversationType.DISCUSSION, Conversation.ConversationType.CUSTOMER_SERVICE, Conversation.ConversationType.CHATROOM, Conversation.ConversationType.SYSTEM};
