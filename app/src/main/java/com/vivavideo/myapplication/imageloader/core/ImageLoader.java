...
import com.vivavideo.myapplication.imageloader.core.assist.LoadedFrom;
import com.vivavideo.myapplication.imageloader.core.assist.ViewScaleType;
import com.vivavideo.myapplication.imageloader.core.imageaware.ImageAware;
import com.vivavideo.myapplication.imageloader.core.imageaware.ImageViewAware;
import com.vivavideo.myapplication.imageloader.core.imageaware.NonViewAware;
...
import com.vivavideo.myapplication.imageloader.core.listener.SimpleImageLoadingListener;
import com.vivavideo.myapplication.imageloader.utils.ImageSizeUtils;
...
public class ImageLoader {
	 ...
	 * @param imageAware {@linkplain com.vivavideo.myapplication.imageloader.core.imageaware.ImageAware Image aware view}
	 ...
	 * @param imageAware {@linkplain com.vivavideo.myapplication.imageloader.core.imageaware.ImageAware Image aware view}
	 *                   which should display image
	 * @param options    {@linkplain com.vivavideo.myapplication.imageloader.core.DisplayImageOptions Options} for image
	 ...
	 * @param progressListener {@linkplain com.vivavideo.myapplication.imageloader.core.listener.ImageLoadingProgressListener
	 *                         Listener} for image loading progress. Listener fires events on UI thread if this method
	 *                         is called on UI thread. Caching on disk should be enabled in
	 *                         {@linkplain com.vivavideo.myapplication.imageloader.core.DisplayImageOptions options} to make
	 *                         this listener work.
	 * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	 ...
	 * {@link com.vivavideo.myapplication.imageloader.core.imageaware.ImageAware ImageAware}
	 */
	 ...
	 * {@link com.vivavideo.myapplication.imageloader.core.imageaware.ImageAware ImageAware}.
	 *
	 * @param imageAware {@link com.vivavideo.myapplication.imageloader.core.imageaware.ImageAware ImageAware} for
	 ...
	 * {@linkplain com.vivavideo.myapplication.imageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
