 ...
 *******************************************************************************/
package com.vivavideo.myapplication.imageloader.core;
...
import com.vivavideo.myapplication.imageloader.cache.disc.DiskCache;
import com.vivavideo.myapplication.imageloader.cache.disc.naming.FileNameGenerator;
import com.vivavideo.myapplication.imageloader.cache.memory.MemoryCache;
import com.vivavideo.myapplication.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.vivavideo.myapplication.imageloader.core.assist.FlushedInputStream;
import com.vivavideo.myapplication.imageloader.core.assist.ImageSize;
import com.vivavideo.myapplication.imageloader.core.assist.QueueProcessingType;
import com.vivavideo.myapplication.imageloader.core.decode.ImageDecoder;
import com.vivavideo.myapplication.imageloader.core.download.ImageDownloader;
import com.vivavideo.myapplication.imageloader.core.process.BitmapProcessor;
import com.vivavideo.myapplication.imageloader.utils.L;
import com.vivavideo.myapplication.imageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.vivavideo.myapplication.imageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.vivavideo.myapplication.imageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.vivavideo.myapplication.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.vivavideo.myapplication.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.vivavideo.myapplication.imageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.vivavideo.myapplication.imageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.vivavideo.myapplication.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.vivavideo.myapplication.imageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.vivavideo.myapplication.imageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.vivavideo.myapplication.imageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.vivavideo.myapplication.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.vivavideo.myapplication.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.vivavideo.myapplication.imageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.vivavideo.myapplication.imageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
