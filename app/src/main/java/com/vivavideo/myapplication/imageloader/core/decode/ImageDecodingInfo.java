 ...
 *******************************************************************************/
package com.vivavideo.myapplication.imageloader.core.decode;
...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain (String, ImageSize) image key} (used in memory cache).  io.rong.imageloader.utils.MemoryCacheUtils#generateKey*/
